    ...
    <div class="myCard q-pa-lg">
      <div class="row items-center q-mb-lg">
        ...
        <q-btn
          color="secondary"
          icon="group_add"
          :label="$t('admin.users.bulkCreate')"
          ...
          <q-td :props="props">
            <q-avatar size="30px">
              ...
              <q-avatar v-else color="primary" text-color="white" size="30px">
                {{ props.row.firstName?.charAt(0).toUpperCase()
                }}{{ props.row.lastName?.charAt(0).toUpperCase() }}
              </q-avatar>
            </q-avatar>
          </q-td>
        </template>
      ...
      <q-card style="min-width: 600px">
        ...
        <q-card-section>
          <div class="q-mb-md">
            <q-file
              v-model="excelFile"
              :label="$t('admin.users.importExcel')"
              outlined
              dense
              accept=".xlsx, .xls"
            ...
            >
              ...
              <template v-slot:append>
                <q-btn
                  ...
                  dense
                  icon="close"
                  @click.stop.prevent="excelFile = null"
                  v-if="excelFile"
                />
              </template>
            </q-file>
...
const columns = computed(() => [
  ...
  {
    name: "group",
    label: t("admin.users.columns.group"),
    field: "group",
    align: "left",
    sortable: true,
  },
...
const confirmDelete = (user: any) => {
  Dialog.create({
    ...
    $q.notify({
      message: t("admin.users.deleteNotImplemented"),
      color: "warning",
    });
  });
};
